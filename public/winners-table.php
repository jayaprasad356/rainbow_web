...
<section class="content-header">
    <h1>Winners /<small><a href="home.php"><i class="fa fa-home"></i> Home</a></small></h1>
    <!-- <ol class="breadcrumb">
        <a class="btn btn-block btn-default" href="add-managers.php"><i class="fa fa-plus-square"></i> Add New Managers</a>
    </ol> -->
</section>
    <!-- Main content -->
